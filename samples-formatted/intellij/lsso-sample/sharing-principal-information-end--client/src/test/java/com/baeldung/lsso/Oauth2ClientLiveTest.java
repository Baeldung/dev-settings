...
public class Oauth2ClientLiveTest {
    ...
    public void givenAuthorizationCodeGrant_whenLoginUsingOauth_thenSuccess() throws UnsupportedEncodingException {
        ...
        response = RestAssured.given().redirects().follow(false).cookie("JSESSIONID", newClientSessionId).formParam("name", "newProjectName").formParam("_csrf", csrfToken).post(PROJECTS_RESOURCE_URL);
