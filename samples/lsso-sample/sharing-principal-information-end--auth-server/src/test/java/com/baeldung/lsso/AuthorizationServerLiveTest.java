...
public class AuthorizationServerLiveTest {
    ...
    public void whenServiceStartsAndLoadsRealmConfigurations_thenOidcDiscoveryEndpointIsAvailable() {
        ...
        assertThat(HttpStatus.OK.value()).isEqualTo(response.getStatusCode()); System.out.println(response.asString()); assertThat(response.jsonPath()
    ...
    private String obtainAccessToken() {
        ...
        Response response = RestAssured.given()
            .redirects()
            .follow(false)
            .get(AUTHORIZE_URL); String authSessionId = response.getCookie("AUTH_SESSION_ID"); String kcPostAuthenticationUrl = response.asString()
