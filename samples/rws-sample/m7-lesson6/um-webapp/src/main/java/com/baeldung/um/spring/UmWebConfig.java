...
public class UmWebConfig implements WebMvcConfigurer {
    ...
    public void extendMessageConverters(final List<HttpMessageConverter<?>> converters) {
        final Optional<HttpMessageConverter<?>> jsonConverterFound = converters.stream()
            ...
            .findFirst(); if (jsonConverterFound.isPresent()) {
            final AbstractJackson2HttpMessageConverter converter = (AbstractJackson2HttpMessageConverter) jsonConverterFound.get(); converter.getObjectMapper()
        ...
        final Optional<HttpMessageConverter<?>> xmlConverterFound = converters.stream()
            ...
            .findFirst(); if (xmlConverterFound.isPresent()) {
